...
- **Image Processing**: The image is preprocessed to enhance its features and optimize the text
detection process. This may involve techniques such as resizing, normalization, and noise reduction to improve the clarity and quality of the image.
...
## How to use Image Extraction AI
...
<Card title="View API Reference to Implement" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/ai-models/text-extraction/image-extraction">
  Visit the API Reference to learn how to implement Image Extract AI in your projects. Get access to

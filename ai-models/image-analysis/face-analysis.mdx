...
Visit the API Reference to learn how to implement Face Analysis AI in your projects. Get access to Sample
...
<Card title="View API Reference to Implement" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/ai-models/image-analysis/face-analysis">
  Visit the API Reference to learn how to implement Face Analysis AI in your projects. Get
  access to

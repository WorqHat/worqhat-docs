...
<Warning>
  Keep in mind that the File Object should be a maximum resolution of ``16 megapixels`` and a max file size of ``30 Mb``.
</Warning>
...
For detailed guidance on how to implement the Replace Image Background API in your projects, including sample code and a comprehensive list of API endpoints, please refer to our API Reference section. You also have the opportunity to test the API directly in your browser, allowing you to experience its capabilities firsthand.

<Card title="View API Reference for Implementation" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/ai-models/image-generation/replace-image-background">
  Explore the API Reference for detailed instructions on integrating the Replace Image Background API into your projects. Access sample code, discover API endpoints, and experiment with the API functionality directly in your browser.
</Card>

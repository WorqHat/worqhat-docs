...
<Card title="View API Reference for Implementation" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/ai-models/image-generation/remove-text-image">
  Explore the API Reference for detailed guidance on implementing the Remove Text from Image API in your projects. Access sample code, discover API endpoints, and test functionality directly in your browser.
</Card>

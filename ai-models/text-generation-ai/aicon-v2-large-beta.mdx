...
<Info>
  When you pass the data to the model using the Training Data field, you are only limited to 100,000
  words. If you want to pass more than 100,000 words, you will have to pass the data
  directly to the model for training. You can find updates on how you can train your own data in
...
<Warning>
    ...
    request to the API and you will receive an error. You can pass your data to the model
    directly as well. Visit our ``API Reference`` to learn more.
</Warning>

## How to use AiCon V2 Large Model (Beta)
...
Visit the API Reference to learn how to implement AiCon V2 Large Model in your projects. Get access to Sample
...
<Card title="View API Reference to Implement" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/ai-models/text-generation-ai/aicon-v2-large-beta">
...
You can train your own data using the API Reference. You can pass your data to the model using
the Training Data field. The model will process the data and cache it so that it is available for
future requests. This will help you save time and costs on processing.

<Card title="Train, View and Delete Datasets" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/ai-models/text-generation-ai/aicon-train-datasets">
  Visit the API Reference to learn how to implement AiCon V2 Large Model in your projects. Get
  access
  to
  Sample Code, API Endpoints and run it right within the browser to test it out.

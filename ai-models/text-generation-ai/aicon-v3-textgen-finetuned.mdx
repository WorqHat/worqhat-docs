---
title: 'AiCon V3 (Fine Tuned)'
description: 'Advanced Generation AI focused for more creative and understanding capabilities.'
---

AiCon V3, the most powerful content generation AI, and our largest ever model, has captured the attention of
developers
worldwide with its groundbreaking capabilities. With data upto Dec 2023, it is one of our largest and best models till date. Previously, access to this remarkable AI model
was limited to a few companies like Bloomberg, Walmart, Canva via the WorqHat Workspaces and APIs. The capabilities of AiCon V3 have been demonstrated in a variety of domains, including
...
<Warning>
  Please note that the **AiCon V3 Model** has a word capacity limit of `200,000 words` in a single
...
<Card title="View API Reference to Implement" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/ai-models/text-generation-ai/aicon-v3-textgen-finetuned">

...
* `aicon-v4-large-160824` **(finetuned included):** Our smartest and highest accuracy model, suitable for a wide range of text generation tasks, complex thought and reasoning along with mathematical solutions.

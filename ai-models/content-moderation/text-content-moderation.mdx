...
## How to use Content Moderation AI
...
Visit the API Reference to learn how to implement Content Moderation AI in your projects. Get access to Sample
...
<Card title="View API Reference to Implement" icon="link" iconType="duotone" color="#ea5a0c"
      href="/api-reference/ai-models/content-moderation/text-content-moderation">
  Visit the API Reference to learn how to implement Content Moderation AI in your projects. Get
  access to

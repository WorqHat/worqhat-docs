---
title: 'Rate Limits'
description: 'WorqHat AI API Rate Limits for Safe Usage'
---
...
<Warning>During the BETA period, we will be adjusting rate limits as needed based on BETA usage. We
  will
  notify users of any changes to the rate limits.</Warning>

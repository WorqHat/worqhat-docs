...
| --------- | ------------------ | -------------------------------------------------------------------------- | ----------- |
| image     | `File` or `string` | The existing image to be analysed. This can be a local file path or a URL. |
...
```python
from worqhat import detect_faces
from dotenv import load_dotenv
load_dotenv()
image=["path-to-your-image/url-to-image"]
r=detect_faces(image=image,api_key="Your-api-key")
print(r)

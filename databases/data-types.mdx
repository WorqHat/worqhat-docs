...
| `date` | This data type represents a date value. _Limited Support. Try using timestamp_ | Ideal for storing date-related information such as birth dates, event dates, or any other date-specific data. |

...
<Warning>If at any time you have concerns or are uncertain whether your security research is
  consistent
  with this policy, please submit an inquiry via [support@worqhat.com](mailto:support@worqhat.com)
  before going any further.</Warning>
...
<CardGroup cols={2}>
  ...
  <Card
    title="Hall of Fame"
    icon="image"
    href="https://worqhat.com/hall-of-fame"
  >
